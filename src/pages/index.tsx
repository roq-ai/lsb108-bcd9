  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience Lsb108 - Your reliable assistant for tracking user interactions. Unleash the power of analytics with our bot."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1485827404703-89b55fcc595e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxib3R8ZW58MHx8fHwxNzAwMDAwODE1fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@agk42?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Alex Knight`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience Lsb108 - Your reliable assistant for tracking user interactions. Unleash the power of analytics with our bot.`}
            </Text>
            <Box
