...
export function useBotFindMany<
  T extends Prisma.botFindManyArgs,
  R extends GetFindResult<Prisma.$botPayload<DefaultArgs>, T>[],
>(args?: Prisma.SelectSubset<T, Prisma.botFindManyArgs>, options?: RequestOptions, swrOptions?: SWRRequestOptions<R>) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useBotFindMany', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.bot.findMany(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useBotCount<T extends Prisma.botCountArgs, R extends number>(
  args?: Prisma.SelectSubset<T, Prisma.botCountArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useBotCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.bot.count(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useBotFindManyWithCount<
  T extends Prisma.botFindManyArgs,
  R extends { data: GetFindResult<Prisma.$botPayload<DefaultArgs>, T>[]; count: number },
>(args?: Prisma.SelectSubset<T, Prisma.botFindManyArgs>, options?: RequestOptions, swrOptions?: SWRRequestOptions<R>) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useBotFindManyWithCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.bot.findManyWithCount(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useBotFindFirst<
  T extends Prisma.botFindFirstArgs,
  R extends GetFindResult<Prisma.$botPayload<DefaultArgs>, T>,
>(args?: Prisma.SelectSubset<T, Prisma.botFindFirstArgs>, options?: RequestOptions, swrOptions?: SWRRequestOptions<R>) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useBotFindFirst', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.bot.findFirst(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useInteractionFindMany<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useInteractionFindMany', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.interaction.findMany(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useInteractionCount<T extends Prisma.interactionCountArgs, R extends number>(
  args?: Prisma.SelectSubset<T, Prisma.interactionCountArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useInteractionCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.interaction.count(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useInteractionFindManyWithCount<
  T extends Prisma.interactionFindManyArgs,
  R extends { data: GetFindResult<Prisma.$interactionPayload<DefaultArgs>, T>[]; count: number },
>(
  args?: Prisma.SelectSubset<T, Prisma.interactionFindManyArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useInteractionFindManyWithCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.interaction.findManyWithCount(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useInteractionFindFirst<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useInteractionFindFirst', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.interaction.findFirst(args, options);
      return result as R;
    },
    {
      ...swrOptions,
